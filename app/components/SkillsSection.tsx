...
export default function SkillsSection() {
  ...
  return (
    <section id="skills" className="relative py-20 px-6 md:px-12 max-w-6xl mx-auto">
      ...
      <ScrollReveal direction="right" delay={0.1}>
        <div className="flex items-center space-x-3 mb-12 text-xs font-mono tracking-widest text-neutral-400 dark:text-neutral-500 uppercase">
          ...
          <span>PROGRAMMING LANGUAGES, FRAMEWORKS AND DATABASE</span>
        </div>
      </ScrollReveal>
          ...
          >
            <div className="flex items-center justify-between p-5 bg-white dark:bg-[#161618] border border-neutral-200/80 dark:border-neutral-800 hover:border-neutral-400 dark:hover:border-neutral-700 transition-all duration-300 group cursor-default">
              <div className="flex items-center space-x-4">
                ...
                <span className="text-sm font-medium text-neutral-800 dark:text-neutral-200 group-hover:text-neutral-950 dark:group-hover:text-white transition-colors">
                  {skill.name}
                </span>
              </div>
